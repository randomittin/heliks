      ...
      _close: function (b, c, d) {
        ...
        if (
          ...
          if ('closed' != e.__state) {
            ...
            if (
              ('disappearing' == e.__state && l > e.__closingTime && (i = !1),
              i)
            ) {
              (e.__closingTime = l),
...
function initTooltipster(containerToInit) {
  ...
  $(containerToInit)
    .not('.tooltipstered')
    .find('[tooltipster="top"]:not(.tooltipstered)')
    .tooltipster({
      position: 'top',
      trigger: 'custom',
  ...
  $(containerToInit)
    .not('.tooltipstered')
    .find('[tooltipster="bottom"]:not(.tooltipstered)')
    .tooltipster({
      position: 'bottom',
      trigger: 'custom',
      triggerOpen: tooltipsterTriggerOpen,
  ...
  $(containerToInit)
    .not('.tooltipstered')
    .find('[tooltipster="left"]:not(.tooltipstered)')
    .tooltipster({
      position: 'left',
      trigger: 'custom',
      triggerOpen: tooltipsterTriggerOpen,
  ...
  $(containerToInit)
    .not('.tooltipstered')
    .find('[tooltipster="right"]:not(.tooltipstered)')
    .tooltipster({
      position: 'right',
      trigger: 'custom',
      triggerOpen: tooltipsterTriggerOpen,
  ...
  $(containerToInit)
    .not('.tooltipstered')
    .find('[tooltipster="right-delay"]:not(.tooltipstered)')
    .tooltipster({
      position: 'right',
      trigger: 'custom',
      triggerOpen: tooltipsterTriggerOpen,
  ...
  $(containerToInit)
    .not('.tooltipstered')
    .find('[tooltipster="top-delay"]:not(.tooltipstered)')
    .tooltipster({
      position: 'top',
      trigger: 'custom',
      triggerOpen: tooltipsterTriggerOpen,
  ...
  $(containerToInit)
    .not('.tooltipstered')
    .find('[tooltipster="left-delay"]:not(.tooltipstered)')
    .tooltipster({
      position: 'left',
      trigger: 'custom',
      triggerOpen: tooltipsterTriggerOpen,
  ...
  $(containerToInit)
    .not('.tooltipstered')
    .find('[tooltipster="bottom-delay"]:not(.tooltipstered)')
    .tooltipster({
      position: 'bottom',
      trigger: 'custom',
      triggerOpen: tooltipsterTriggerOpen,
  ...
  $(containerToInit)
    .not('.tooltipstered')
    .find('[tooltipster="right-on-click"]:not(.tooltipstered)')
    .tooltipster({
      position: 'right',
      trigger: 'custom',
  ...
  $(containerToInit)
    .not('.tooltipstered')
    .find('[tooltipster="top-on-click"]:not(.tooltipstered)')
    .tooltipster({
      position: 'top',
      trigger: 'custom',
      triggerOpen: tooltipsterTriggerOpenOnClick,
  ...
  $(containerToInit)
    .not('.tooltipstered')
    .find('[tooltipster="left-on-click"]:not(.tooltipstered)')
    .tooltipster({
      position: 'left',
      trigger: 'custom',
      triggerOpen: tooltipsterTriggerOpenOnClick,
  ...
  $(containerToInit)
    .not('.tooltipstered')
    .find('[tooltipster="bottom-on-click"]:not(.tooltipstered)')
    .tooltipster({
      position: 'bottom',
      trigger: 'custom',
      triggerOpen: tooltipsterTriggerOpenOnClick,
